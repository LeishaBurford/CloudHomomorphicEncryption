...
public class LongData {
    ...
    private static long p; // private key, this needs to be the same for all LongData objects
    private static long[] x; // public key, this needs to be the same for all LongData objects
    ...
    // rhoPrime = 8
    // eta = 4^2 = 16
    // gamma = lambda ^ 5 = 4^5 = 1024
    // t = gamma + lambda = 1024 + 4 = 1028
    ...
    public LongData(long value, boolean encrypted) {
        if(testing)
    ...
    // initialize LongData, default assumes value is unencrypted
