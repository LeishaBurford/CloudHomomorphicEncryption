...
public class DGHVAlice {

    public static void main(String[] args) {

        // create the files -- this is the goal
        BigData fileZero = new BigData(BigInteger.ZERO, false);
        BigData fileOne = new BigData(BigInteger.ONE, false);
        ...
        for(int i = 0; i < 10; i++) {
            ...
            fileZero = new BigData(BigInteger.ZERO, false);
            fileOne = new BigData(BigInteger.ONE, false);
